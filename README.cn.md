...
![intelli-shell](https://repo.x-cmd.io/intelli-shell.svg?lang=zh)

## 安装

```sh
x install intelli-shell
```

## 代码洞察

合计: **22,976** 行代码（覆盖前 5 种语言、共 **105** 个文件）。
...
- **上游仓库**: <https://github.com/lasantosr/intelli-shell>
- **官网**: <https://lasantosr.github.io/intelli-shell/>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v3.4.5` (2026-06-26)
- **最近提交**: 2026-07-26
- **Release 含资产**: 8 个

## 流行度

- **Star**: 1,286 · **Fork**: 23 · **开放 issue**: 50 · **贡献者**: 8

## 累计统计

- **发布数**: 34 · **已合并 PR**: 15 · **开放 PR**: 0 · **已关闭 issue**: 44 · **开放 issue**: 6 · **提交数**: 159
...
| last60d | 2026-07-13 | 0 | 1 | 0 | 2 | 2 | 1 |
| 90d | 2026-06-13 | 2 | 2 | 0 | 3 | 2 | 7 |
| last180d | 2026-03-15 | 5 | 8 | 0 | 4 | 2 | 22 |
| 360d | 2025-09-16 | 12 | 14 | 0 | 23 | 5 | 68 |
| last720d | 2024-09-21 | 23 | 14 | 0 | 32 | 6 | 109 |
...
在 [repology.org](https://repology.org/project/intelli-shell) 上共有 **12** 个发行版报告此项目。**7** 个 ✅ 已是最新上游版本，**4** 个 ⚠️ 使用旧版本。
...
intelli-shell 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `intelli-shell` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/intelli-shell.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T04:57:01Z._
