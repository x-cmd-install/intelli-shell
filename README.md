...
[![x-cmd/install — intelli-shell Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/intelli-shell.svg)](https://x-cmd.com/install/intelli-shell)
...
- **Stars**: 1,292 · **Forks**: 23 · **Open issues**: 50 · **Contributors**: 8

## Totals (cumulative)

- **Releases**: 34 · **Merged PRs**: 15 · **Open PRs**: 0 · **Closed issues**: 44 · **Open issues**: 6 · **Commits**: 159
...
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/intelli-shell.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260926.yml` · 2026-09-26T05:13:51Z._
